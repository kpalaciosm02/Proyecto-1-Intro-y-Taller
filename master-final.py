...
def encrypt(x, llave):
    ...
    if x in BM:
        return BM[(BM.index(x)+llave)%len(BM)]
    else:
        return x
...
def encryptFinal(x,llave):
    ...
    yList=keyGenerator(llaveBin,len(x)) 
    #print(yList)
    #print(y)
...
#print(encryptFinal("Pruebas",15))
#print(decryptFinal("Eyxdlsm",15))
print(encryptFinal("Hola mundo",25))
print(decryptFinal("Gapn uyprt",25))
#print(Dec_B(5))